  ...
  PRODUCTS: [
    ...
    },
    {
      ...
      colors: [
        ...
        { id: "camouflage biege", name: "Камуфляж Беж", hex: "#e4e3beff", images: ["images/img.balaklava/13.png","images/img.balaklava/14.png","images/img.balaklava/15.png","images/img.balaklava/15.png"], price: 549 },
]
    },
    {
      id: "shapka+baf",
    ...
    },
     {
      ...
      price: 1349,
      colors: [
        { id: "graphite", name: "Графіт", hex: "#616267", images: ["images/img.plushh/10.png","images/img.plushh/11.png","images/img.plushh/12.png","images/img.plushh/9.png","images/img.plushh/8.png","images/img.plushh/7.png"], price: 1349 },
        { id: "black", name: "Чорний", hex: "#111113ff", images: ["images/img.plushh/1.png","images/img.plushh/2.png","images/img.plushh/3.png","images/img.plushh/4.png","images/img.plushh/5.png","images/img.plushh/6.png"], price: 1349 },
        { id: "khaki", name: "Хакі", hex: "#4B5320", images: ["images/img.plushh/19.png","images/img.plushh/21.png","images/img.plushh/20.png"], price: 1349 },
        { id: "biege", name: "Беж", hex: "#d6c7b1", images: ["images/img.plushh/13.png","images/img.plushh/14.png","images/img.plushh/15.png","images/img.plushh/16.png","images/img.plushh/17.png","images/img.plushh/18.png"], price: 1349 },
]
    },
    {
      id: "zmeyka",
...
if (main) main.src = activeImages[currentIndex];
}
